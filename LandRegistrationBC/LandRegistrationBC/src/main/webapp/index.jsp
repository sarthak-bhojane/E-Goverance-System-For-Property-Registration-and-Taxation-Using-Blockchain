<%@page import="services.JsonReaderBing"%>
...
jobj.GetLatNLng("Laxmi Vihar, Amravati", "444605");
%>
<!-- Header -->
			...
			<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#stats">Registration</a></li>
...
<!-- //serach --> 
<!-- about -->
	<div class="about w3layouts-agileinfo" id="login">
		<div class="container">
